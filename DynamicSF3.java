...
public class DynamicSF3 extends BaseClassSalesForceDynamic34 {

	@Test(dataProvider = "SF3")

	public void dynamicSF3(String question, String detail) throws InterruptedException {
	...
	@DataProvider(name = "SF3")
	public String[][] testdata() throws IOException {
		String[][] readData = ReadExcel3.dynamic3();// Classname.methodname
		return readData;
	}
