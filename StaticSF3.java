...
public class StaticSF3 extends BaseClassSalesForceStatic34 {

	@Test(dataProvider = "testdata")

	public void staticSF3(String uname, String pass, String app, String question, String detail)
	...
	public String[][] testdata() {
		...
		data[0][2] = "Content";
		data[0][3] = "coming from excel";
		data[0][4] = "coming from excel";
